 ...
 */
package pbo3.pkg10117089.latihan40.warnakepribadian;
...
public class Warna {
    ...
    public void inputNamaWarna (String parWarna, String parNama){
      Scanner scn = new Scanner(System.in);
        ...
        parNama = scn.next();
         ...
         System.out.println("===HASIL TEST KEPRIBADIAN "+parNama+("==="));
